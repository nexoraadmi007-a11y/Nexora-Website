...
function careerProgramme(): CommercialProgramme {
  ...
  return {
    ...
    description: 'A modular AI Career Accelerator with independent programmes in AI content creation, AI-powered UI/UX design, and AI financial analysis.',
    targetAudience: ['NYSC members', 'Final-year students', 'Graduates', 'Young professionals', 'Career builders'],
    ...
    outcomes: ['Practical AI skill development', 'Portfolio-ready project work', 'Career direction clarity', 'Certificate after successful completion'],
    ...
    approvedValuePoints: ['Structured learning path', 'Practical projects', 'Guided support', 'Feedback', 'Portfolio development', 'Capstone review'],
    ...
    faqs: [
      ...
      { question: 'How long is each programme?', answer: 'Each Career Accelerator programme runs for 4 weeks.' },
    ],
