...
const tables = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'Private File Data', type: 'multilineText' },
      ...
      { name: 'Signed Letter Status', ...singleSelect(['SIGNED_COPY_UPLOADED', 'SIGNED_COPY_UNDER_REVIEW', 'CORRECTION_REQUIRED', 'SIGNED_COPY_APPROVED', 'REJECTED']) },
      { name: 'Employment Letter Reference', type: 'singleLineText' },
      { name: 'Employment Letter Version', type: 'number', options: { precision: 0 } },
